...
7. Go to [FlashXML.net](http://www.flashxml.net/ "Free Flash Components") and [customize your 3D Wall FX](http://www.flashxml.net/3d-wall.html "3D Wall FX") using the Live Demo. Generate the `settings.xml` text and use it to overwrite `flashxml/3d-wall-fx/settings.xml`
8. To use your own images, upload them to the `flashxml/3d-wall-fx/images` folder and update the `flashxml/3d-wall-fx/images.xml` file accordingly
